...
function defaultDB(){
  return {
    settings:{shopName:'Rongsok Jembar',shopPhone:'',shopAddress:''},
    items:[
      {id:uid(),name:'Besi',buy:5000,stock:0},
      {id:uid(),name:'Kardus',buy:2000,stock:0},
      {id:uid(),name:'Aluminium',buy:18000,stock:0},
      {id:uid(),name:'Tembaga',buy:70000,stock:0},
      {id:uid(),name:'Botol Plastik',buy:3000,stock:0}
    ],
    purchases:[]
  };
}
